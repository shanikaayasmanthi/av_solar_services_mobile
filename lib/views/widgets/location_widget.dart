...
class _LocationWidgetState extends State<LocationWidget> {
    ...
    Future<void> _fetchRoute() async {
        ...
        final String url =
            'https://maps.googleapis.com/maps/api/directions/json?origin=${currentLatLng[0]},${currentLatLng[1]}&destination=${widget.lattitude},${widget.longitude}&mode=driving&key=AIzaSyDT7_DvKioBot1xhD742OfHOT9k_1-jcvs'; // Ensure this key matches AndroidManifest.xml
                                                ...
                                                Positioned(
                                                    ...
                                                    child: Row(
                                                        children: [
                                                            ...
                                                            const SizedBox(width: 8),
                                                            ElevatedButton(
                                                                onPressed: widget.onOpenGoogleMaps, // Updated: Now triggers the callback from LocationScreen
                                                                style: ElevatedButton.styleFrom(
                                                                    backgroundColor: bgGreen,
                                                                    foregroundColor: bgWhite,
                                                                    shape: RoundedRectangleBorder(
